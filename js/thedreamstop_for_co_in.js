...
$scope.login=function()
{
  if($scope.vname!="" && $scope.vpass!="")
  {
    ...
    var req = 
      {    method: 'POST',
         url: 'http://thedreamstop.co.in/api/dashboard.php', 
...
$scope.searchlist=function(){
  ...
  //console.log(JSON.stringify($scope.data));
    ...
    var req = 
    {    method: 'POST',
       url: 'http://thedreamstop.co.in/api/search.php', 
       headers: { 'Content-Type':'application/x-www-form-urlencoded' },
...
$scope.logout=function()
{
  ...
  var req = 
    {    method: 'POST',
       url: 'http://thedreamstop.co.in/api/logout.php', 
       headers: { 'Content-Type':'application/x-www-form-urlencoded' },
       data: $.param($scope.data),
     } 
...
app.controller('itemdisplay', ['$scope','$localstorage','$http','category',function($scope,$localstorage,$http,category){
  ...
  //console.log('chchch'+JSON.stringify($scope.data));
    ...
    var req = 
    {    method: 'POST',
       url: 'http://thedreamstop.co.in/api/catProds.php', 
       headers: { 'Content-Type':'application/x-www-form-urlencoded' },
       data: $.param($scope.data),
     } 
...
app.controller("cart",['$localstorage','$scope','$http','$filter',function($localstorage,$scope,$http,$filter)
  {
    ...
    var req = 
    { method: 'POST',
      url: 'http://thedreamstop.co.in/api/userInfo.php', 
      headers: { 'Content-Type':'application/x-www-form-urlencoded' },
    ...
    $scope.addorder=function()
    {
     ...
     //console.log(JSON.stringify($scope.data));
      var req = 
        { method: 'POST',
          url: 'http://thedreamstop.co.in/api/addOrder.php', 
          headers: { 'Content-Type':'application/x-www-form-urlencoded' },
          data: $.param($scope.data),
        } 
...
app.controller("tiles",['$localstorage','$scope','$http','category',function($localstorage,$scope,$http,category)
  {
    ...
    $http.get("http://thedreamstop.co.in/api/listCategories.php")
...
app.controller("login",['$scope','$http','$localstorage','UserService',function($scope,$http,$localstorage,$rootScope,UserService) {
  ...
  $scope.userlogin=function()
  {
    ...
    if($scope.user.password!="" && $scope.user.email!="")
    {
      ...
      var req = 
      {    method: 'POST',
         url: 'http://thedreamstop.co.in/api/login.php', 
         headers: { 'Content-Type':'application/x-www-form-urlencoded' },
          ...
          { 
            ...
            geocoder.geocode( { 'address': address}, function(results, status) 
            {
              if (status == google.maps.GeocoderStatus.OK) 
              {
                ...
                var req2 = 
                {  method: 'POST',
                    url: 'http://thedreamstop.co.in/api/latlong.php', 
                    headers: { 'Content-Type':'application/x-www-form-urlencoded' },
...
$scope.useredit=function()
{
  ...
  var req = 
  { method: 'POST',
    url: 'http://thedreamstop.co.in/api/editInfo.php', 
    headers: { 'Content-Type':'application/x-www-form-urlencoded' },
    data: $.param(newuser),
  } 
...
$scope.sendPost = function() 
{
  ...
  var req=
  { method: 'POST',
    url: 'http://thedreamstop.co.in/api/newUser.php',
    headers: { 'Content-Type':'application/x-www-form-urlencoded' },
    data: $.param($scope.user),
  }
...
$scope.open=function(id)
{
  ...
  if(op%2==1)
  {
    var req1=
    { method: 'POST',
      url: 'http://thedreamstop.co.in/api/viewTransaction.php',
      headers: { 'Content-Type':'application/x-www-form-urlencoded' },
...
var req=
  { method: 'POST',
    url: 'http://thedreamstop.co.in/api/orderHistory.php',
    headers: { 'Content-Type':'application/x-www-form-urlencoded' },
...
$(document).ready(function()
  { 
      ...
      for(var i=0;i<$scope.cities.length;i++)
      {
        var req=
        { method: 'POST',
          url: 'http://thedreamstop.co.in/api/locList.php',
          headers: { 'Content-Type':'application/x-www-form-urlencoded' },
